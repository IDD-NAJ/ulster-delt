import { AlertCircle, Mail, Phone, Clock, FileText } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          <p className="text-xl text-gray-600 mb-6">
            We take all complaints seriously and are committed to resolving them fairly and promptly. Our complaints process is designed to be transparent and customer-focused.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-4">Complaints Policy</h2>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We are committed to providing excellent service and handling complaints fairly and efficiently.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Where appropriate, we may offer compensation for any inconvenience caused.
                </p>
              </div>
            </div>
          </div>
